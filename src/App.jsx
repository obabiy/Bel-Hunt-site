  ...
  return (
    <Router>
      ...
      <div id = "siteContainer">
        ...
        <button id = "scrollTop" onClick = {scrollPage}>CLICK</button>
        <Footer/>
      </div>
    </Router>
  );
